/*
 Mostly for Arduino Mega due to multiple Serial required
Otherwise need to implement the Serial.end method (and save tag to SD or EEPROM)
...
//#define BM019_TX p9
//#define BM019_RX p11
#define BM019_TX 2 //D8
#define BM019_RX 8 //D2
