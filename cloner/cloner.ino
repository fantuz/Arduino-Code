...
const int dataSize = 500; //700 //Arduino memory is limited (max=1700)
byte storedData[dataSize];  //Create an array to store the data
const unsigned int threshold = 95;  //signal threshold value
...
int timeDelay = 95;    //Used to slow down the signal transmission (can be from 75 - 135)
//WIEGAND wg;
...
/* ------------------------------------------------------------------------------
  Listen for the signal from the RF remote. Blink the RED LED at the beginning to help visualise the process and also turn RED LED on when receiving the RF signal
------------------------------------------------------------------------------ */
