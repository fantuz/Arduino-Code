...
#define ENCRYPTKEY    "thisIsEncryptKey" //"TOPSECRETPASSWRD" // Use the same 16-byte key on all nodes

#define USEACK        true // Request ACKs or not

#define LED           13 // LED positive pin //9
...
#define RFM69_CS      9
#define RFM69_IRQ     3
#define RFM69_IRQN    1 //digitalPinToInterrupt(RFM69_IRQ)
#define RFM69_RST     9
