/*
  ...
  This program demonstrates the basic functionality of the Parallax RFID Read/Write Module (#28440). Data is displayed using the Arduino Serial Monitor. 
  ...
  Please refer to the product manual for full details of module functionality and capabilities.
*/
