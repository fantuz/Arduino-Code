...
// Radio chip is controlled by writing 5 bytes one by one. During writing TEA5767  IC2 address is 0x60, reading – 0x61.
// Arduino IDE supports only 7 bit address ant last bite is assigned automatically,  so  in code 0x60 is used as address.
...
#define Button_next 0  //30
#define Button_prev 3  //31
...
//  digitalWrite(Button_prev, HIGH); //pull up resistor
  ...
  frequency=94.4; //87.5; //starting frequency
