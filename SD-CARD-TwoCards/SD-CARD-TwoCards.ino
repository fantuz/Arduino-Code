/*
 * Warning This example requires extra RAM and may crash on Uno. Example use of two SD cards.
 */
...
SdFat sd1;
const uint8_t SD1_CS = 6;  // chip select for sd1

SdFat sd2;
const uint8_t SD2_CS = 5;   // chip select for sd2
